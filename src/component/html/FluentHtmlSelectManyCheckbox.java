...
public interface FluentHtmlSelectManyCheckbox<T extends FluentHtmlSelectManyCheckbox>
    ...
    public default T selectedClassx(String expression) {
        set_value_expression(FacesContext.getCurrentInstance(), (UIComponent) this,
                "selectedClass", expression); return (T) this;
    }
    ...
    public default T unselectedClassx(String expression) {
        set_value_expression(FacesContext.getCurrentInstance(), (UIComponent) this,
                "unselectedClass", expression); return (T) this;
    }
}
