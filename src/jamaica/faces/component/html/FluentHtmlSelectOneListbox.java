...
import jamaica.faces.component.FluentUISelectOne;

public interface FluentHtmlSelectOneListbox<T extends FluentHtmlSelectOneListbox>
            extends FluentUISelectOne<T> {
